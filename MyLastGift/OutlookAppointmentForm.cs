...
namespace MyLastGift
{
    ...
    public partial class OutlookAppointmentForm : DevExpress.XtraBars.Ribbon.RibbonForm, IDXManagerPopupMenu
    {
        ...
        protected virtual void BindControllerToControls()
        {
            ...
            BindProperties(this.tbName, "Text", "Name");
            BindProperties(this.tbDescription, "Text", "Description");
            BindProperties(this.tbNation, "Text", "Nation");
            BindProperties(this.sttComboBox, "Text", "RoomStatus");
            BindProperties(this.roomIDComboBox, "Text", "RoomID");
            BindProperties(this.roomTypeComboBox, "Text", "RoomType");
            BindProperties(this.bookTypeComboBox, "Text", "BookingType");
            BindProperties(this.tbPrice, "Text", "Price");
